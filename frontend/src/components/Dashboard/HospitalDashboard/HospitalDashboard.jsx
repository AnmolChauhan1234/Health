  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setShowModal(true);
        setModalMessage("Could not logout. Try again.");
      ...
      setShowModal(true);
      setModalMessage("Server cannot be reached. Try later:");
      setStatusCode("error");
    ...
    <>
      ...
      <main className="space-y-6">
        ...
        <button
          ...
          className={` text-white px-4 py-2 outline-none border-none rounded-md mx-auto my-3 cursor-pointer ${
            isLoading ? "bg-red-400" : "bg-red-500 hover:bg-red-400"
          }`}
          disabled={isLoading}
        >
